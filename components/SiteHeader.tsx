    ...
    <header className="sticky top-0 z-40 border-b border-line bg-card/85 backdrop-blur-md">
      <div className="mx-auto flex h-14 max-w-[1600px] items-center gap-3 px-3 sm:gap-4 sm:px-5">
        <Link href="/" className="flex shrink-0 items-center gap-2">
          <span className="grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-emerald-400 to-teal-600 text-[#04160e] shadow-[0_0_18px_rgba(52,211,153,0.35)]">
        ...
        <nav className="flex items-center rounded-full border border-line bg-bg p-0.5">
          {TABS.map((t) => {
            ...
            return (
              <Link
                key={t.href}
                href={t.href}
                className={`rounded-full px-2.5 py-1 text-[12.5px] transition-colors sm:px-3.5 ${
                  active
